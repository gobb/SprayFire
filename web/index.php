...
include \dirname(__DIR__) . '/libs/SprayFire/Core/ClassLoader.php';

$ClassLoader = new \SprayFire\Core\ClassLoader();
$ClassLoader->registerNamespaceDirectory('SprayFire', \dirname(__DIR__) . '/libs');
\spl_autoload_register(array($ClassLoader, 'load'));

$SystemLogger = new \SprayFire\Logger\SystemLogger();
\var_dump($SystemLogger->log(LOG_ERR, 'A test of the system log again from SystemLogger::log()'));
